...
EMSCRIPTEN_BINDINGS(Bindings) {
    ...
    */
    ...
    emscripten::class_<QuantumCircuit>("QuantumCircuit")
        ...
        .function("add_S_gate", &QuantumCircuit::add_S_gate)
        ...
        .function("add_RotInvX_gate", &QuantumCircuit::add_RotInvX_gate)
        .function("add_RotInvY_gate", &QuantumCircuit::add_RotInvY_gate)
        .function("add_RotInvZ_gate", &QuantumCircuit::add_RotInvZ_gate)
        .function("add_RotX_gate", &QuantumCircuit::add_RotX_gate)
        .function("add_RotY_gate", &QuantumCircuit::add_RotY_gate)
        .function("add_RotZ_gate", &QuantumCircuit::add_RotZ_gate)
